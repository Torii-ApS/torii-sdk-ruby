...
| **unsafe_metadata** | **Hash&lt;String, Object&gt;** | Deep-merges into the user&#39;s unsafe metadata (a key set to null removes it); omit to leave unchanged. Counts toward the 8 KB combined metadata budget. | [optional] |

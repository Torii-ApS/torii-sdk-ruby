...
module ToriiBackendGenerated
  class ServerUsersApi
    ...
    # @param user_id [String] Identifier of the user to ban.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ServerUserResponse, Integer, Hash)>] ServerUserResponse data, response status code and response headers
    ...
    # @option opts [String] :cursor Opaque cursor returned by the previous page&#39;s &#x60;nextCursor&#x60;. Omit to fetch the first page.
    # @option opts [ServerUserSearchRequest] :server_user_search_request 
    # @return [Array<(CursorPageResponseServerUserResponse, Integer, Hash)>] CursorPageResponseServerUserResponse data, response status code and response headers
    ...
    # @param [Hash] opts the optional parameters
    # @return [ServerUserResponse]
    def update_user_metadata(user_id, update_user_metadata_request, opts = {})
      data, _status_code, _headers = update_user_metadata_with_http_info(user_id, update_user_metadata_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ServerUserResponse, Integer, Hash)>] ServerUserResponse data, response status code and response headers
    def update_user_metadata_with_http_info(user_id, update_user_metadata_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServerUsersApi.update_user_metadata ...'
      end
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling ServerUsersApi.update_user_metadata"
      end
      ...
      if @api_client.config.client_side_validation && update_user_metadata_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_user_metadata_request' when calling ServerUsersApi.update_user_metadata"
      end
      # resource path
      local_var_path = '/api/server/v1/users/{userId}/metadata'.sub('{userId}', CGI.escape(user_id.to_s))
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ServerUsersApi#update_user_metadata\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
